...
#hidden_grid = [50, 50, 50, 50, 50, 50, 50, 50]
#hidden_grid = [[20,20,20],[50, 50]]
...
nn_grid.train(x=h2o_train.names[2:], y = h2o_train.names[3], training_frame = h2o_train, validation_frame = h2o_test)

print(nn_grid.get_grid(sort_by='auc', decreasing=True))
...
plt.savefig('plots/'+njet+'j_'+dsid+'/h2o_var_important.png')

plt.figure()
perf = best_model.model_performance()
perf.plot()
plt.savefig('plots/'+njet+'j_'+dsid+'/h2o_roc.png')
