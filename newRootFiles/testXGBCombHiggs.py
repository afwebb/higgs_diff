    ...
    for l in range(len(lep4Vecs)):
        for i in range(len(jet4Vecs)-1):
            for j in range(i+1, len(jet4Vecs)):
                ...
                if l==0:
                    k = higgsDict( jet4Vecs[i], jet4Vecs[j], lep4Vecs[l], met, jet4VecsMV2c10[i], jet4VecsMV2c10[j], lep4Vecs[1] )
                else:
                    k = higgsDict( jet4Vecs[i], jet4Vecs[j], lep4Vecs[l], met, jet4VecsMV2c10[i], jet4VecsMV2c10[j], lep4Vecs[0] )
...
plt.savefig('plots/higgsTruthScores.png')

plt.figure()
plt.hist(wrongScores, 30)
plt.savefig('plots/higgsRightScores.png')

plt.figure()
plt.hist(wrongScores, 30)
plt.savefig('plots/higgsWrongScores.png')
