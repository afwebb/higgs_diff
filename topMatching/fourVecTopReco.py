...
import random
from dictTop import topDictFourVec2lSS, topDictFourVec3l
...
def runReco(inf):
    ...
    if '3l' in inf:
        topDict = topDictFourVec3l
        is3l = True
    elif '2lSS' in inf:
        topDict = topDictFourVec2lSS
        is3l = False
    else:
    ...
    if is3l:
        dfTop.to_csv('csvFiles/fourVec3l/'+outF, index=False)
    else:
        dfTop.to_csv('csvFiles/fourVec2lSS/'+outF, index=False)        
